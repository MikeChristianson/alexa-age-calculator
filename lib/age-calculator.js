...
var AMAZON_DATE_FORMAT = 'YYYY-MM-DD';
var STRICT_DATE_PARSING = true;

var momentMeasurements = ['years', 'months', 'weeks', 'days'];

exports.calculateAge = function calculateAge(date) {
  var now = moment();
  var birthDate = moment(date, AMAZON_DATE_FORMAT, STRICT_DATE_PARSING);
...
exports.test = function test() {
  var inputs = ['2015-06-12 09:13', '2016-10-01', null, undefined];
